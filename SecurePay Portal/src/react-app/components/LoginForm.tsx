...
export default function LoginForm({ onLogin, onSwitchToRegister, error, loading }: LoginFormProps) {
      ...
      <div className="max-w-md w-full">
        <div className="bg-white/90 backdrop-blur-md rounded-2xl shadow-2xl border border-slate-200/50 p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-600">Sign in to your secure payment portal</p>
          </div>
